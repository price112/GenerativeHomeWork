...
def DiT_B_2_diff(**kwargs):
    return DiT(depth=12, hidden_size=768, patch_size=2, num_heads=12, attn_type='diff', **kwargs)


def DiT_L_2(**kwargs):
    return DiT(depth=24, hidden_size=1024, patch_size=2, num_heads=16, **kwargs)

def DiT_L_2_diff(**kwargs):
    return DiT(depth=24, hidden_size=1024, patch_size=2, num_heads=16, attn_type='diff',**kwargs)
...
def DiT_XL_2_diff(**kwargs):
    return DiT(depth=28, hidden_size=1152, patch_size=2, num_heads=16, attn_type='diff', **kwargs)
